<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list_role.aspx.cs" Inherits="list_role" %>
                ...
                <td>
                    ...
                    <div class="tools_box">
                        <div class="tools_bar">
                            ...
                            <a href="javascript:void(0);" onclick="window.location='main_role.aspx?op=add&rnd='+Math.random()+'&url='+window.location.href;" class="tools_btn" id="tdnewdoc" runat="server">
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <HeaderTemplate>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
                                <tr>
                                    ...
                                    <th align="center" width="10%">权限编号
                                    </th>
                                    <th align="center" width="20%">权限名称
                                    </th>
                                    <th align="center" width="40%">已授权人员
                                    </th>
                                    <th align="center" width="10%">授权
                                    </th>
                        ...
                        <ItemTemplate>
                            <tr height="22" onmouseover="this.className='tr_over'" onmouseout="this.className='tr_out'"
                                ...
                                <td align="center">
                                    <input type="checkbox" name="docids" value="<%#Eval("hy_roleid")%>">
                                </td>
                                <td align="center">
                                    <%#Eval("hy_roleid")%>&nbsp;
                                </td>
                                ...
                                <td align="center">
                                    <%#getRoleUser(Eval("hy_roleid").ToString()) %>
                                </td>
                                <td align="center">
                                    <a href="#" onclick="window.open('../ggdy/Hy_SetRoleByRole.aspx?roleid=<%#Eval("hy_roleid")%>&rnd='+Math.random()+'&url='+window.location.href)">授权</a>
                                </td>
                                <td align="center">
                                    <a href="#" onclick="window.location='main_role.aspx?op=modify&hy_roleid=<%#Eval("hy_roleid")%>&rnd='+Math.random()+'&url='+window.location.href;">修改</a>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
