...
!function () { //初始化地图模块相关代码
    ...
    var jindu = parseFloat($("#txtjd").val());
    var weidu = parseFloat($("#txtwd").val());
    ...
    var myIcon = new BMap.Icon("/images/bz.png", new BMap.Size(37, 62));
    var marker2 = new BMap.Marker(pt, { icon: myIcon });  // 创建标注
    map.addOverlay(marker2);                           //由于有3D图，需要设置城市哦
} ();
...
//    //下拉触发事件
//    $("#zjid1").change(function () {

//        var checkValue1 = parseInt($("#zjid1").val());
//        var checkValue2 = parseInt($("#zjid2").val());
...
//    //下拉触发事件
//    $("#mianji1").change(function () {

//        var mjValue1 = parseInt($("#mianji1").val());
//        var mjValue2 = parseInt($("#mianji2").val());
//        if (mjValue1 <= mjValue2) {
//            keyword = $('#keyword').val();
//            searchAction(keyword);
//        }
...
//        if (checkValue1 <= checkValue2) {
//            value = checkValue1 + "," + checkValue2;   //租金组合
//            type = 'zujin';                //字段名
...
//                type = type + "*"
//            }
//            value = value + "" + mjValue1 + "," + mjValue2;   //面积组合
//            
//            type = type + 'mianji';    //字段名
//                     

//       }
//        var typearry =type.split('*'); //截取字符串数组  
//        var valuearry=value.split('*');
//       
//        $.each(typearry, function(i, k) {   //是each循环  
//         
//          var typezd = typearry[i],
//              valuesj = valuearry[i];              
//              
//             filter.push(typezd + ':' + valuesj);
...
//            'scope': '2',  //显示详细信息
//            'geotable_id': 91416,
//            'ak': 'fmcG8etkki2epYjWX7HctQWc'  //用户ak
...
//            points.push(point);
//            var tr = $("<tr><td width='65%'><a href='/rentmanage/show_rent.aspx?docid=" + item.docid + "' target='_blank' onclick='Util.addLogCount()'>" + item.title + "<a/><br/>" + item.address + "</td><td width='18%'>" + item.zujin + "<br/><span style='color:red;'>元/月</span></td><td width='22%'>" + item.mianji + "<br/><span style='color:red;'>平方米</span></td></tr>").click(showInfo);
//            $('#mapList').append(tr); ;
//            marker.addEventListener('click', showInfo);
//            function showInfo() {
//                var content = "<img src='" + item.tup + "' style='width:111px;height:108px;float:left;margin-right:5px;'/>" +
//                              "<p>名称：" + item.title + "</p>" +
//                              "<p>地址：" + item.address + "</p>" +
//                              "<p>面积：" + item.mianji + "&nbsp;<span style='color:red;'>平方米</p>" +
//                              "<p>租金：" + item.zujin + "&nbsp;<span style='color:red;'>元/月</span></p>";
//                //创建检索信息窗口对象
//                var searchInfoWindow = new BMapLib.SearchInfoWindow(map, content, {
//                    title: item.title,       //标题
//                    width: 290,             //宽度
...
//        * 分页
//        */
//        var pagecount = Math.ceil(res.total / 8);
//        if (pagecount > 20) {
//            pagecount = 20; //最大页数76页
//        }
...
//        $.each(content, function (i, item) {
//            $('#listBoby').append("<tr><td width='13%'><img src='" + item.mainimage + "' style='width:111px;height:83px;'/></td><td width='67%'><a href='" + item.roomurl + "' target='_blank' onclick='Util.addLogCount()'>" + item.title + "<a/><br/>地址：" + item.address + "<br/>类型：" + Util.getLeaseNameByType(item.leasetype) + "</td><td width='20%'>" + item.zujin + " <span style='color:red;'>元/月</span></td></tr>"); ;
//        });
