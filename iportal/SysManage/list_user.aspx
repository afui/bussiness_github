                    ...
                    <div class="tools_box">
                        <div class="tools_bar">
                            ...
                            <div class="search_box">
                                 部门： <asp:DropDownList ID="ddlbmmc" runat="server" OnSelectedIndexChanged="ddl_bmxl_SelectedIndexChanged"
                                                AutoPostBack="true" CssClass="btnSelect">
                                            </asp:DropDownList>&nbsp;&nbsp;姓名：<asp:TextBox ID="txtKeywords" runat="server" CssClass="txtInput"></asp:TextBox>
